 ...
 *
 * @prop {ReadmeScore} ReadmeScore - An API proxy/wrapper that
...
const githubRestClientOptions = require('./github-rest-client-options')
...
const octokit = new Octokit(githubRestClientOptions)
